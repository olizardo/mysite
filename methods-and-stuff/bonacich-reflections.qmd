...
Here I show how the Bonacich centrality fits into the reflection idea, and why this means it is a different metric from that yielded by HH's reflection method. This also the difference between Bonacich and Correspondence Analysis (CA), because the HH reflection method is equivalent to CA. 
