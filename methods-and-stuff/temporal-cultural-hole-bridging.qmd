...
$$
     JJ = A^TA
$${#eq-1}
As I noted in the previous [discussion](poly.qmd), once we have $JJ$, we have the ingredients to compute most measures of similarity between jobs (and by implication distance in some categorical space). 
