...
The figure shows evidence consistent with EH's claims. Indeed, Merchants end up near the upper-left hand quadrant of the two-dimensional space, nearer the last two periods (1690-1710), indicating that they dominate the discussion during this era. They are maximally contrasted from authors with a military background (who are naturally better represented in more bellicose periods), and authors with a Yeoman background (who are better represented in the late sixteenth century). The CA also reveals insights not evident in the tabular presentation. First, Noblemen are also better represented among economics authors in the later period, even if they are less numerous than merchants. Second, clergymen are more or less evenly represented across periods, ending up close to the plot's origins. 

# Example 3: Relationship Between Class and Mode of Aesthetic Self-Presentation 
In a fascinating paper, van den Haak and Wilterdink---hereafter HW---analyze interview data from a sample of ninety Dutch people more or less evenly divided into three groups by class situation: Stayers in the less educated stratum, stayers in the more educated stratum, and movers from the low to the high educated stratum. HW asked this people about their cultural tastes, other people's cultural tastes, and whether there was such a thing as good and bad taste. 
