ref.plot <- function(x, max.iter) {
     ...
     return(list(person = list(all.refs = pr.long, even.refs = pr.long.e, odd.refs = pr.long.o), 
                 group = list(all.refs = gr.long, even.refs = gr.long.e, odd.refs = gr.long.o)))
}