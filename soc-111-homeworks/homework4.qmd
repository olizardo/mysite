...
Consider the graph shown in Figure @fig-grex1:
...
1. Write down *all* the **paths** connecting node *A* and node *D*:
<br>
<br>
<br>
<br>
...
1. Write down the the **shortest path(s)** connecting nodes *G* and *I*:
<br>
<br>
<br>
<br>
...
1. Write down *every* that **cycle** starts and ends with node *F*:
<br>
<br>
<br>
<br>
...
1. Write down *all* the **directed path(s)** going *from* node *G* *to* node *B*:
<br>
<br>
<br>
<br>
...
1. Write down *every* that **cycle** starts and ends with node *D*:
<br>
<br>
<br>
<br>
