...
Rank all the nodes in the graph shown in @fig-grex2 by their **degree centrality**.
...
Rank all the nodes in the graph shown in @fig-grex1 by their **outdegree centrality** and **indegree centrality**.
