...
1. List the nodes in all the **cliques** of *size five* in the graph.
<br>
<br>
<br>
<br>
...
1. List the nodes in one of the **2-cliques** in the graph:
<br>
<br>
<br>
<br>
...
1. Using the **Jaccard Similarity** metric, compute the structural similarity between nodes *K* and *N* in the graph shown in @fig-grex1.
<br>
<br>
<br>
<br>

1. Using the **Dice Similarity** metric, compute the structural similarity between nodes *L* and *M* in the graph shown in @fig-grex1.
<br>
<br>
<br>
<br>

1. Using the **Cosine Similarity** metric, compute the structural similarity between nodes *D* and *B* in the graph shown in @fig-grex1.
<br>
<br>
<br>
<br>
