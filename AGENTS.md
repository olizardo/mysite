...
4. **CV Generation:** The CV is a single, self-contained Quarto document. Any updates, additions, or modifications to the CV should be made directly in `cv.qmd` using standard Markdown formatting.
